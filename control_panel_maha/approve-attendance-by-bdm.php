        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $BdmComment = addslashes(trim($_POST["HrComment"]));
                    $BdmStatus = addslashes(trim($_POST["HrStatus"]));
                    $Narration = addslashes(trim($_POST["Narration"]));
                    $CreatedDate = date('Y-m-d');
                    $CreatedTime = date('h:i a');
                    $query2 = "UPDATE tbl_attendance_request SET BdmApproveDate='$ApproveDate',BdmComment='$BdmComment',BdmStatus='$BdmStatus',BdmBy='$user_id' WHERE id = '$id'";
                    $conn->query($query2);
                    if ($BdmStatus == 1) {
                        if ($AttRoll == 0) {
                    ...
                    @approval_mail_notify($conn, 'attendance', (int)$id, 'bdm', $BdmStatus, (int)$user_id, $BdmComment);
                    echo "<script>alert('Approved Successfully!');window.location.href='bdm-pending-attendance-request.php';</script>";
