        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query2 = "UPDATE tbl_expense_request SET ApproveDate='$ApproveDate',MannagerComment='$MannagerComment',MgrAmount='$MgrAmount',ManagerStatus='$ManagerStatus',MrgBy='$user_id' $hrClause WHERE id = '$id'";
                    $conn->query($query2);
