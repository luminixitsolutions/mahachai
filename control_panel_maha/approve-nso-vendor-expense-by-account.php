...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
  ...
  @approval_mail_notify($conn, 'nso_vendor_expense', (int)$id, 'account', $ManagerStatus, (int)$user_id, $MannagerComment);
...
<option value="Tax Invoice" <?php if($row7["InvType"] == 'Tax Invoice') {?> selected <?php } ?>>
 ...
 <div class="form-group col-md-12">
                        ...
                        <a href="../uploads/nso_expenses/<?php echo $row7['Photo']; ?>" target="_blank">View</a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
                        ...
                        <a href="../uploads/nso_expenses/<?php echo $row7['Photo2']; ?>" target="_blank">View</a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
