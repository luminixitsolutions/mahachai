...
//   $dlttempid = "1707174567025998983";
  ...
  @approval_mail_notify($conn, 'nso_vendor_expense', (int)$id, 'nso', $ManagerStatus, (int)$user_id, $MannagerComment);
...
?>
 ...
 <div class="form-group col-md-5">
                                       ...
                                       <!-- <div class="form-group col-md-3">
                                         ...
                                         <!--<div class="form-group col-md-2">
                                            <label class="form-label">First Approve Amount</label>
                                            <input type="text" class="form-control"
                                                placeholder="" value="<?php echo $row7["NsoAmount"]; ?>" readonly>
                                            <div class="clearfix"></div>
                                        </div>-->
