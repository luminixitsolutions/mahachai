...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET Locations='$Locations',NsoApproveDate='$ApproveDate',NsoComment='$MannagerComment',NsoAmount='$MgrAmount',NsoStatus='$ManagerStatus',NsoBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
   if($ManagerStatus == 2){
...
//   $dlttempid = "1707174567025998983";
  ...
  @approval_mail_notify($conn, 'nso_vendor_expense', (int)$id, 'nso_first', $ManagerStatus, (int)$user_id, $MannagerComment);
  echo "<script>alert('Approved Successfully!');window.location.href='nso-vendor-pending-expense-request-first.php';</script>";
...
<div class="form-row">
 ...
 <div class="form-group col-md-12">
                        ...
                        <a href="../uploads/nso_expenses/<?php echo $row7['Photo']; ?>" target="_blank"><img src="../uploads/nso_expenses/<?php echo $row7['Photo']; ?>"  style="height:100px;"></a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
                        ...
                        <a href="../uploads/nso_expenses/<?php echo $row7['Photo2']; ?>" target="_blank">View Pdf</a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
