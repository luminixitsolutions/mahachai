...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET InvoiceNo='$InvoiceNo',GrnNo='$GrnNo',Locations='$Locations',PurchaseApproveDate='$ApproveDate',PurchaseComment='$MannagerComment',PurchaseAmount='$MgrAmount',PurchaseStatus='$ManagerStatus',PurchaseBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
...
//   $dlttempid = "1707174567041279389";
  ...
  @approval_mail_notify($conn, 'nso_vendor_expense', (int)$id, 'purchase', $ManagerStatus, (int)$user_id, $MannagerComment);
